...
> This module now lives in [`opstimus/terraform-modules`](https://github.com/opstimus/terraform-modules) at `modules/aws-site-to-site-vpn`.
>
> ```hcl
> source = "git::https://github.com/opstimus/terraform-modules.git//modules/aws-site-to-site-vpn?ref=aws-site-to-site-vpn/v2.0.0"
> ```
>
